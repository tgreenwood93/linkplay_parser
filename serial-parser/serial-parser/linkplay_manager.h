...
void LP_Set_linkplay_ethernet_status();
...
void LP_Set_linkplay_internet_status();
...
void LP_Set_linkplay_playback_mode();
uint8_t LP_Get_linkplay_playback_mode();

void LP_Set_linkplay_repeat_shuffle();
uint8_t LP_Get_linkplay_repeat_shuffle();

void LP_Set_linkplay_playback();
uint8_t LP_Get_linkplay_playback();
...
void LP_Set_linkplay_hotspot_status();
...
void LP_Set_linkplay_rtc_weekday();
uint8_t LP_Get_linkplay_rtc_weekday();

void LP_Set_linkplay_silent_firmware_update();
uint8_t LP_Get_linkplay_silent_firmware_update();

void LP_Set_linkplay_wireless_access_status();
